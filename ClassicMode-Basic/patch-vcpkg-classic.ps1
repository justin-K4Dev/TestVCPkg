<#=================================================================================================
  patch-vcpkg-classic.ps1 (Windows PowerShell 7.2+)
  - Scripts\cleanup-vcpkg-classic.ps1 호출 및 파라미터 설정
=================================================================================================#>
...
$upgradeScript = Join-Path $PSScriptRoot '..\Scripts\upgrade-vcpkg-classic.ps1'
